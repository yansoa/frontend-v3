...
export function reward(params: any) {
  return client.get("/addons/MultiLevelShare/api/v1/user/goods/reward", params);
}
export function bind(params: any) {
  return client.post("/addons/MultiLevelShare/api/v1/user/bind", params);
}
